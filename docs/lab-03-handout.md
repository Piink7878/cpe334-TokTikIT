## Lab 3: Tok TickIT Users, Roles, IT Staff Ticketing, and Admin Screens
...
Example fields may include: Ticket No, Created Date, Summary, Category, Req Priority, IT Priority, Status, Owner, and Last Updated. Students must justify the final set and avoid an unreadable mega-grid.
...
Use a branch flow similar to Lab 2, but here for Lab 3. (Feature branches -> `lab3-staging` -> `main`).
